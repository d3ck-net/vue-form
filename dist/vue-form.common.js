...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["n"] = warn;
...
/* harmony export (immutable) */ __webpack_exports__["k"] = on;
/* harmony export (immutable) */ __webpack_exports__["j"] = off;
/* harmony export (immutable) */ __webpack_exports__["b"] = attr;
/* harmony export (immutable) */ __webpack_exports__["m"] = trigger;
/* harmony export (immutable) */ __webpack_exports__["c"] = camelize;
/* harmony export (immutable) */ __webpack_exports__["l"] = pull;
/* unused harmony export get */
/* harmony export (immutable) */ __webpack_exports__["e"] = each;
/**
 * Utility functions.
 */
...
/* harmony default export */ __webpack_exports__["d"] = (function (Vue) {
    util = Vue.util;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__validators__ = __webpack_require__(11);
...
const Validator = {
    ...
    types: __WEBPACK_IMPORTED_MODULE_0__validators__,
    ...
    remove(dir) {
        Object(__WEBPACK_IMPORTED_MODULE_1__util__["l" /* pull */])(this.dirs, dir);
    },
    ...
    validate(el, submit) {
        ...
        if (submit && results.invalid) {
            Object(__WEBPACK_IMPORTED_MODULE_1__util__["m" /* trigger */])(validator.el, 'invalid');
        }
...
/* harmony export (immutable) */ __webpack_exports__["c"] = Validator;
...
const Directive = {
    ...
    bind() {
        ...
        this.name = Object(__WEBPACK_IMPORTED_MODULE_1__util__["c" /* camelize */])(name);
    ...
    results(results) {
        this.vm.$set(this.name, Object(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* assign */])({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__fields__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__validate__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__validator__ = __webpack_require__(1);
/**
 * Install plugin.
 */
...
function plugin(Vue) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__util__["d" /* default */])(Vue);

    Vue.fields = __WEBPACK_IMPORTED_MODULE_1__fields__["b" /* fields */];
    Vue.component('fields', Object(__WEBPACK_IMPORTED_MODULE_1__fields__["a" /* default */])(Vue));

    Vue.validator = __WEBPACK_IMPORTED_MODULE_3__validator__["c" /* Validator */];
    Vue.filter('valid', __WEBPACK_IMPORTED_MODULE_3__validator__["b" /* Filter */]);
    Vue.directive('validator', __WEBPACK_IMPORTED_MODULE_3__validator__["a" /* Directive */]);
    Vue.directive('validate', __WEBPACK_IMPORTED_MODULE_2__validate__["a" /* Validate */]);
    Vue.vueForm = {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__templates_default_html__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__templates_default_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__templates_default_html__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shims__ = __webpack_require__(6);
...
/* harmony default export */ __webpack_exports__["a"] = (function (Vue) {
    ...
    return {
        ...
        mixins: [__WEBPACK_IMPORTED_MODULE_3__shims__["a" /* default */]],
        props: {
        ...
        created() {
            ...
            if (!this.fields || !this.values) {
                Object(__WEBPACK_IMPORTED_MODULE_2__util__["n" /* warn */])('Invalid config or model provided');
                return;
            }

            Object(__WEBPACK_IMPORTED_MODULE_2__util__["e" /* each */])(Object(__WEBPACK_IMPORTED_MODULE_2__util__["a" /* assign */])({}, Vue.fields, fields), (type, name) => {

                if (Object(__WEBPACK_IMPORTED_MODULE_2__util__["h" /* isString */])(type)) {
                    type = {template: type};
                }

                if (Object(__WEBPACK_IMPORTED_MODULE_2__util__["g" /* isObject */])(type)) {
                    type.name = type.name || `field-${name}`;
                    type = Vue.extend(__WEBPACK_IMPORTED_MODULE_0__field__["a" /* default */]).extend(type);
                }
        ...
        methods: {
            ...
            filterFields(config) {
                ...
                var arr = Object(__WEBPACK_IMPORTED_MODULE_2__util__["f" /* isArray */])(config), fields = [];

                Object(__WEBPACK_IMPORTED_MODULE_2__util__["e" /* each */])(config, (field, name) => {

                    if (!Object(__WEBPACK_IMPORTED_MODULE_2__util__["h" /* isString */])(field.name) && !arr) {
                        field.name = name;
                    }

                    if (!Object(__WEBPACK_IMPORTED_MODULE_2__util__["h" /* isString */])(field.type)) {
                        field.type = 'text';
                    }

                    if (Object(__WEBPACK_IMPORTED_MODULE_2__util__["h" /* isString */])(field.name)) {
                        ...
                        Object(__WEBPACK_IMPORTED_MODULE_2__util__["n" /* warn */])(`Field name missing ${JSON.stringify(field)}`);
                    }
            ...
            evaluate(expr, data) {
                ...
                if (Object(__WEBPACK_IMPORTED_MODULE_2__util__["h" /* isString */])(expr)) {
        ...
        template: __WEBPACK_IMPORTED_MODULE_1__templates_default_html___default.a
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    data() {
        return Object(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* assign */])({
            name: '',
            type: 'text',
            label: '',
            attrs: {},
    ...
    computed: {
        ...
        attributes: {
            ...
            get() {
                ...
                if (this.enable && !this.$parent.evaluate(this.enable)) {
                    return Object(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* assign */])({disabled: 'true'}, this.attrs);
                }
        ...
        value: {
            ...
            get() {
                ...
                if (Object(__WEBPACK_IMPORTED_MODULE_0__util__["i" /* isUndefined */])(value) && !Object(__WEBPACK_IMPORTED_MODULE_0__util__["i" /* isUndefined */])(this.default)) {
            ...
            set(value) {
                ...
                if (!Object(__WEBPACK_IMPORTED_MODULE_0__util__["i" /* isUndefined */])(this.value) || value) {
    ...
    methods: {
        ...
        filterOptions(options) {
            ...
            if (!options) {
                Object(__WEBPACK_IMPORTED_MODULE_0__util__["n" /* warn */])(`Invalid options provided for ${this.name}`);
                return opts;
            }

            Object(__WEBPACK_IMPORTED_MODULE_0__util__["e" /* each */])(options, (value, name) => {
                if (Object(__WEBPACK_IMPORTED_MODULE_0__util__["g" /* isObject */])(value)) {
...
var Validate = {
    ...
    bind() {
        ...
        var name = Object(__WEBPACK_IMPORTED_MODULE_1__util__["b" /* attr */])(this.el, 'name');
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__util__["k" /* on */])(this.el, 'blur', this.listener.bind(this));
        Object(__WEBPACK_IMPORTED_MODULE_1__util__["k" /* on */])(this.el, 'input', this.listener.bind(this));

        __WEBPACK_IMPORTED_MODULE_0__validator__["c" /* Validator */].add(this);
    },

    unbind() {

        Object(__WEBPACK_IMPORTED_MODULE_1__util__["j" /* off */])(this.el, 'blur', this.listener);
        Object(__WEBPACK_IMPORTED_MODULE_1__util__["j" /* off */])(this.el, 'input', this.listener);

        __WEBPACK_IMPORTED_MODULE_0__validator__["c" /* Validator */].remove(this);
    },
    ...
    listener(e) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__validator__["c" /* Validator */].validate(this.el);
    },
    ...
    validator() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0__validator__["c" /* Validator */].types[this.type];
    }
...
Object(__WEBPACK_IMPORTED_MODULE_1__util__["k" /* on */])(document, 'mousedown', related.handler);
Object(__WEBPACK_IMPORTED_MODULE_1__util__["k" /* on */])(document, 'pointerdown', related.handler);
Object(__WEBPACK_IMPORTED_MODULE_1__util__["k" /* on */])(document, 'touchstart', related.handler);
...
/* harmony export (immutable) */ __webpack_exports__["numeric"] = numeric;
/* harmony export (immutable) */ __webpack_exports__["integer"] = integer;
/* harmony export (immutable) */ __webpack_exports__["float"] = float;
/* harmony export (immutable) */ __webpack_exports__["alpha"] = alpha;
/* harmony export (immutable) */ __webpack_exports__["alphanum"] = alphanum;
/* harmony export (immutable) */ __webpack_exports__["email"] = email;
/* harmony export (immutable) */ __webpack_exports__["url"] = url;
/* harmony export (immutable) */ __webpack_exports__["minlength"] = minlength;
/* harmony export (immutable) */ __webpack_exports__["maxlength"] = maxlength;
/* harmony export (immutable) */ __webpack_exports__["length"] = length;
/* harmony export (immutable) */ __webpack_exports__["min"] = min;
/* harmony export (immutable) */ __webpack_exports__["max"] = max;
/* harmony export (immutable) */ __webpack_exports__["pattern"] = pattern;
/**
 * Validator functions.
 */
